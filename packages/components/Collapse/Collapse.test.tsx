...
describe("Collapse.vue", () => {
  beforeAll(() => {
    ...
    headers = wrapper.findAll(".yaque-collapse-item__header");
    contents = wrapper.findAll(".yaque-collapse-item__wapper");
  ...
  test("手风琴模式 错误处理", () => {
    ...
    expect(warn.mock.calls).toMatchInlineSnapshot(
      `
        [
          [
            [YaqueElementError: [YaqueCollapse] accordion mode should only have one active item],
          ],
        ]
      `
    );
